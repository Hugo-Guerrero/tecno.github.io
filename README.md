            ...
            <div class="p-4 border-b border-gray-100 cursor-pointer" onclick="goToAppDetail()">
                <div class="relative rounded-xl overflow-hidden shadow-lg h-48 bg-gray-800 group">
                    ...
                    <div class="absolute bottom-0 left-0 p-4 bg-gradient-to-t from-black/90 via-black/50 to-transparent w-full">
                        <h2 class="text-white font-bold text-xl mb-1">Tecno App</h2>
            ...
            <div class="pt-2 px-5 pb-4">
                ...
                <div class="flex overflow-x-auto hide-scrollbar space-x-4 pb-2">
                    ...
                    <div class="flex flex-col w-24 flex-shrink-0" onclick="goToAppDetail()">
                        ...
                        <span class="text-xs text-gray-900 font-medium truncate">Tecno App</span>
        ...
        <div class="px-5 py-4">
            <div class="flex mb-6">
                ...
                <div class="ml-5 flex flex-col justify-center">
                    <h1 class="text-xl font-bold text-gray-900 leading-tight mb-1">Tecno App</h1>
                    <a href="#" class="text-[#01875f] font-medium text-sm mb-1">Hugo Guerrero v1</a>
            ...
            <div class="flex justify-between items-center mb-6 px-2 border-r border-gray-100">
                <div class="flex flex-col items-center flex-1 border-r border-gray-200">
                    <div class="flex items-center font-bold text-gray-800 text-sm">
                        4.8 <i class="fa-solid fa-star text-[10px] ml-1"></i>
                    </div>
                    <span class="text-[10px] text-gray-500 mt-1">1.2K reseñas</span>
                </div>
                <div class="flex flex-col items-center flex-1 border-r border-gray-200">
                    <div class="flex items-center font-bold text-gray-800 text-sm">
                        15 MB
            ...
            <div class="w-full mb-6">
                ...
                <a id="download-link" href="aplicacion/tecno.apk" download="tecno.apk" class="hidden"></a>
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">
                    Tecno App es una aplicación de herramientas avanzadas desarrollada por Hugo Guerrero. Descarga la versión APK para acceder a todas las funcionalidades sin restricciones. Ruta del archivo: <code class="bg-gray-100 px-1 rounded">aplicacion/tecno.apk</code>
                </p>
            </div>
            ...
            <div class="flex flex-wrap gap-2 mb-6">
                ...
                <span class="px-3 py-1 rounded-full border border-gray-300 text-xs font-medium text-gray-600">APK</span>
            </div>
             ...
             <div>
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-600">¡Funciona excelente! La descarga fue rápida y la instalación muy sencilla. El archivo estaba en la ruta correcta.</p>
                </div>
             </div>
...
<script>
    ...
    function startDownload() {
        ...
        function finishDownload() {
            ...
            // Cambiar la función del botón para que ahora "abra" la app
            btn.onclick = function() {
                showToast("Abriendo Tecno App...");
            };

            // 4. TRIGGER DE LA DESCARGA REAL desde aplicacion/tecno.apk
            try {
                // Disparar la descarga real
                downloadLink.click();
                showToast("✅ Descarga completada: tecno.apk");
                
                // Mostrar mensaje adicional sobre la ubicación
                setTimeout(() => {
                    showToast("Archivo guardado en: aplicacion/tecno.apk", 4000);
                }, 1000);
            } catch (e) {
                console.error("Error al descargar", e);
                showToast("⚠️ Error al descargar. Verifica la ruta.");
            }
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch('aplicacion/tecno.apk', { method: 'HEAD' })
            .then(response => {
                if (!response.ok) {
                    console.warn('El archivo tecno.apk no está disponible en la ruta especificada');
                }
            })
            .catch(error => {
